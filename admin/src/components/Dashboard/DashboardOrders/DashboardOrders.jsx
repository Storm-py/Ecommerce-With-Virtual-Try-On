  ...
  return (
    <div className="orders-page">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">View and manage all your recent orders</p>
      </div>
      
      {/* Order Filters and Search */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8 shrink grow">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="relative w-full md:w-auto">
            <input
              ...
              className="w-full px-4 py-2 pl-10 bg-gray-100 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#ff491f] focus:bg-white"
              value={searchTerm}
              ...
              {filteredOrders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link 
                      to={`/orders/${order.id}`} 
                      className="text-[#ff491f] hover:text-orange-700 mr-4"
                    >
                      View Details
                    </Link>
                    {order.status === 'processing' && (
      ...
      {/* Pagination */}
      {filteredOrders.length > 0 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 px-6 py-4 mt-4 flex items-center justify-between">
